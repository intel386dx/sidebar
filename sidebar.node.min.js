// sidebar.node.min.js - a client-server sidebar for Node.js | Copyright (c) 2023 Hilman Ahwas A. | This script, Marked, and dependency modules is licensed under the MIT license; DOMPurify is licensed under the Apache license and the Mozilla Public License.
console.log("Minified version of sidebar.node.js");tries=0;maxTries=3;function main(){try{tries=tries+1;const daemonPort=8080;const sidebarPort=8081;const formPort=8082;const sidebarHTML=`<!DOCTYPE html>
        <html>
            <head>
                <meta charset="utf-8">
        ...
        </html>`;const sidebarCSS=`:root, html, body {
            width: 100vw;
            height: 100vh;
        }
        :root, html {
        ...
        * {
        ...
        startWebSocket()`;const formHTML=`<!DOCTYPE html>
        <html>
            <head>
                <meta charset="utf-8">
                <meta name="viewport" content="width=device-width, initial-scale=1.0">
