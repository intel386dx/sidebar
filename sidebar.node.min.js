tries=0;maxTries=3;function main(){try{tries=tries+1;const daemonPort=8080;const sidebarPort=8081;const formPort=8082;const sidebarHTML=`<!DOCTYPE html>
        <html>
            <head>
                <meta charset="utf-8">
        ...
        </html>`;const sidebarMiniHTML=`<!DOCTYPE html>
        <html>
            <head>
                <meta charset="utf-8">
                <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        * {
        ...
        function changeStatus(status) {
            ...
            if (body && typeof body !== "undefined" && body != null) body.setAttribute("condition", status);
        ...
        startWebSocket(null, null)`;const formHTML=`<!DOCTYPE html>
        <html>
            <head>
                <meta charset="utf-8">
                <meta name="viewport" content="width=device-width, initial-scale=1.0">
