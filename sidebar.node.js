...
function main() {
    try {
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Assets used for the Sidebar's web interfaces are defined here, mostly as template literals.
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        * {
        ...
        function previewMessage(message) {
            ...
            previewOutput.document.write('<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Preview Message</title></head><style>*{font-family:sans-serif} code,kbd,output,pre{font-family:monospace}</style><body><div class="preview">' + message + '</div></body></html>');
        };
        ...
        function preview () {
            ...
            if ($i("message-type").value == "markdown") {
                ...
                msgpreview = "<pre>" + $i("message-content").value + "</pre>";
            } else {
                return;
            };
        ...
        // This is licensed under the Apache License and the Mozilla Public License; see the LICENSE file in the 
        // DOMPurify repository for more information
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        const purifyJS = 
        ...
        // Sidebar UI
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        const sidebarServer = http.createServer((req, res) => {
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        // The WebSocket server so real-time updating made possible
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        const ws = require("ws");
